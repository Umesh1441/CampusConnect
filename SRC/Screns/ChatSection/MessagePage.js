...
const socket = io('http://192.168.43.24:3001')
...
const MessagePage = ({ navigation, route }) => {
                ...
                fetch('http://192.168.43.24:3000/userdata', {
                    ...
                    .then(res => res.json()).then(data => {
                        if (data.message == 'User Found') {
                            ...
                            fetch('http://192.168.43.24:3000/otheruserdata', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json',
                                },
    ...
    const sendMessage = async () => {
        ...
        fetch('http://192.168.43.24:3000/savemessagetodb', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    const loadMessages = async() => {
        fetch('http://192.168.43.24:3000/getmessages', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
